view: web_push_delivered {
  sql_table_name: iterable.web_push_delivered_view ;;
  drill_fields: [id]
  ...
  dimension: browser_token {
    type: string
    sql: ${TABLE}.browser_token ;;
  }
  ...
  dimension: web_push_body {
    type: string
    sql: ${TABLE}.web_push_body ;;
  }

  dimension: web_push_click_action {
    type: string
    sql: ${TABLE}.web_push_click_action ;;
  }

  dimension: web_push_icon {
    type: string
    sql: ${TABLE}.web_push_icon ;;
  }

  dimension: web_push_message {
    type: string
    sql: ${TABLE}.web_push_message ;;
  }
